...
//                        boolean hasDependants = dbf.exist("//admin/refs_by/ref_by[@published='yes']");
                        ...
                        if (rights.equals("guest") || rights.equals("sysadmin")) {
                            ...
                            System.out.println(displayMsg);
                            hresponse.sendRedirect(synthesisURL + "/SystemMessages?message=" + displayMsg + "&file=" + xmlId + "&lang=" + lang + "&feXMLEditor=yes&type=" + type);
                    ...
                    hresponse.sendRedirect("Index?type=" + type + "&id=" + id + "&lang=" + lang + "&category=" + category);
                } else if (action.equals("New")) {
                    String rights = getRights();
                    if (rights.equals("guest") || rights.equals("sysadmin")) {
                        displayMsg = "ACCESS_DENIED";
                        System.out.println(displayMsg);
                        hresponse.sendRedirect(synthesisURL + "/SystemMessages?message=" + displayMsg + "&file=" + xmlId + "&lang=" + lang);
